...
The goal is to identify the microbial communities, analyze shared and unique taxa, screen for the 3 *nif* genes, and establish a pipeline for analyzing the rest of the samples for functional insights.

## BioBead project

![](06-presentation_files/LSINW%202025%20BioBead.png){width="3200"}
...
## Phylogenetic tree for the rhizosphere soil
...
![Rubio LM, Ludden PW. 2008. Biosynthesis of the Iron-Molybdenum Cofactor of Nitrogenase. Annu Rev Microbiol. 62(1):93--111. doi:10.1146/annurev.micro.62.081307.162737.](06-presentation_files/Nitrogen-fixation-nif-gene-cluster-of-Klebsiella-pneumoniae-Genes-encoding-the_W640.jpg)
...
-   nifH detected but no *nif*D or *nif*K

    -   could be present but not assembled

    -   nifH is a marker gene and more abundant; also subject to HGT. Could be: operons or dormant

    -   could screening for **alternative nitrogenase genes**: `vnfDHK`, `anfDHK`
